...
import com.sunjunjie.educenter.utils.ConstantWxUtils;
import com.sunjunjie.educenter.utils.HttpClientUtils;
...
public class WxApiController {
    ...
    public String callback(String code, String state) {
        try {
            ...
            return "redirect:http://localhost:52728?token="+jwtToken;
        }catch(Exception e) {
